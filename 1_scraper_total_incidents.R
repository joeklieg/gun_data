...
BASE_URLS <- paste0("http://www.gunviolencearchive.org/reports/total-number-of-incidents?year=", 2014:2018, "&page=")
incident_url <- "http://www.gunviolencearchive.org"
pages <- 0:17 #enter the page ranges served by GVA for that year
...
df_2014 <-  map_df(pages, function(i) {
        ...
        data.frame(table, incident_extract, stringsAsFactors=FALSE)
